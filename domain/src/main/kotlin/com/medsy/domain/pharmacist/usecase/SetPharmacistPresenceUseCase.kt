...
class SetPharmacistPresenceUseCase @Inject constructor(
    private val repository: PharmacistRepository
) {
    suspend operator fun invoke(onDuty: Boolean): MedsyResult<PresenceStatus, MedsyError> {
        return repository.setPresence(onDuty)
    }
}
